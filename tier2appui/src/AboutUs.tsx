...
const AboutUs = () => {
    return(<><Helmet>
        ...
        <Typography> We are in no way affiliated to government. We just source the information from the UK government provided sponsor list.</Typography>
        <Typography>We also donot provide recruitment services to people. The sole aim of this website is providing a search interface and nothing else. </Typography>
